...
export async function POST(req){
  try{
    ...
    if(b.action==='concepts') return NextResponse.json({concepts:await generateConcepts(b.product,b.creativeDirection||'',b.deckFormulaId||'auto',b.characterMode||'dani',b.referenceStyleId||'auto_ref')});
