...
export const SLIDE_TYPES = {
  ...
  N4:{name:'Feature Product Shot',kind:'product_ugc',product:true,textStyle:'type3',instruction:'Casual real-world product photo with 1–2 checkable feature callouts reserved for overlay.'},
  ...
  N16:{name:'Mobile Chat Story',kind:'chat',product:true,textStyle:'type7',instruction:'Generate the embedded casual UGC photo only; renderer builds the generic chat UI and exact text.'},
